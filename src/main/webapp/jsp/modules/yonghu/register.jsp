...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(https://img1.baidu.com/it/u=2972578308,97159975&fm=253&fmt=auto&app=138&f=JPEG?w=610&h=400) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		border-width: 5px;
		border-style: solid;
		border-color: rgba(89, 153, 255, 1);
    ...
    #registerForm .emails .btn {
        ...
        background-color: rgba(89, 153, 255, 1);
