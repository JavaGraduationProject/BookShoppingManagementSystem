...
<html>
	...
	<style type="text/css">
		...
		#header .navs li.current {
			color: rgba(2,14,139, 1);
			font-size: 16px;
			border-radius: 0;
			border-width: 0 0 0 6px;
			border-style: solid;
			border-color: rgba(2,14,139, 1);
			background-color: rgba(247, 247, 247, 0);
			box-shadow: 0 0 3px rgba(0,0,0,.1);
		}
		#header .navs li:hover {
			...
			border-style: solid;
			border-color: rgba(2,14,139, 1);
			background-color: rgba(0, 16, 182, 0);
			box-shadow: 0 0 3px rgba(0,0,0,.1);
		}
	</style>
	<body>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 16, 182, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"10px auto 30px auto","borderColor":"rgba(255,255,255,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"1px 0","width":"40%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="desc"></div>
		</div>
