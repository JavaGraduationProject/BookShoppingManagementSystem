		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"rgba(110,22,64,0)","borderStyle":"solid"}'>
				<div class="box" style='width:1100px'>
					  ...
					  <span>DATA SHOW</span><span>图书分类展示</span>
					</div>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(14, 66, 165, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"4px","alignItems":"center","borderWidth":"2px","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"rgba(74, 74, 74, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>图书分类</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(14, 66, 165, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"2px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="tushufenlei" id="tushufenlei" placeholder="图书分类" autocomplete="off" class="layui-input">
						</div>
						...
						<div class="list news" style="position: relative;width: 100%;">
							<div @click="jump('../tushufenlei/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='1'?'list-item1':3=='3'?'list-item3':''">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				function pageList() {
			        ...
			        if (jquery('#tushufenlei').val()) {
			          param['tushufenlei'] = jquery('#tushufenlei').val() ? '%' + jquery('#tushufenlei').val() + '%' : '';
			        }
				...
				if (jquery('#tushufenlei').val()) {
					...
					// 获取列表数据
					http.request('tushufenlei/list', 'get', param, function(res) {
