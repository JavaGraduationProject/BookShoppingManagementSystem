		...
		<div id="app">
			...
			<div class="paper-container">
				...
				<div class="btn-container">
					<span style="font-size: 18px;font-weight: bold;color: rgba(110,22,64,1);margin-right: 20px;">
						总价：{{totalPrice}}RMB
					</span>
					<button :style='{"padding":"0 10px","boxShadow":"0 0 6px #1433a3","margin":"0 5px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","color":"rgba(0, 16, 182, 1)","borderRadius":"4px","borderWidth":"0","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}'  @click="buyClick" type="button" class="layui-btn layui-btn-lg btn-theme">
